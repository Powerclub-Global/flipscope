...
import { HomePage, FinancialsPage, FieldPage, FeedPage, PortalPage, RiskPage, TeamPage, LiveScopePage } from './pages/live'
import type { Ctx } from './pages/live'
import {
  CopilotPage, DealPage, CapturePage, BidsPage, DesignPage,
